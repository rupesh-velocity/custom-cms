          ...
          {activeTab === 'attachments' && (
            <div>
              <div className="bg-white rounded-md shadow-sm border border-gray-200">
                <div className="grid grid-cols-12 gap-8 py-6 px-6 border-b border-gray-100">
                  <div className="col-span-4">
                    <label className="text-[14px] font-bold text-gray-700">Single Media Title</label>
                  </div>
                  <div className="col-span-8">
                    <SeoVariableInput
                      value={settings.seo_attachment_title || ''}
                      onChange={(val) => handleChange('seo_attachment_title', val)}
                      placeholder="%title% %page% %sep% %sitename%"
                    />
                    <div className="mt-2">
                      <span className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">Example</span>
                      <p className="text-[14px] text-[#0066c0] mt-1 hover:underline cursor-pointer truncate">What Is AI Digital Marketing? A Complete Guide for Businesse...</p>
                      <p className="text-[12px] text-gray-500 mt-2">Default title tag for single Media pages. This can be changed on a per-post basis on the post editor screen.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-12 gap-8 py-6 px-6 border-b border-gray-100">
                  <div className="col-span-4">
                    <label className="text-[14px] font-bold text-gray-700">Single Media Description</label>
                  </div>
                  <div className="col-span-8">
                    <SeoVariableInput
                      value={settings.seo_attachment_desc || ''}
                      onChange={(val) => handleChange('seo_attachment_desc', val)}
                      placeholder="%excerpt%"
                    />
                    <div className="mt-2">
                      <span className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">Example</span>
                      <p className="text-[13px] text-gray-600 mt-1">AI digital marketing combines artificial intelligence technologies with digital marketing strategies to automate tasks, analyze customer behavior, and deliver...</p>
                      <p className="text-[12px] text-gray-500 mt-2">Default description for single Media pages. This can be changed on a per-post basis on the post editor screen.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-12 gap-8 py-6 px-6 border-b border-gray-100">
                  ...
                  <div className="col-span-8">
                    <SearchableSelect
                      options={schemaOptions}
                      value={settings.seo_attachment_schema_type || ''}
                      onChange={(val) => handleChange('seo_attachment_schema_type', val)}
                    />
                    <p className="text-[13px] text-gray-500 mt-2">Default rich snippet selected when creating a new post of this type. If <code className="bg-gray-100 px-1 py-0.5 rounded text-[12px]">Article</code> is selected, it will be applied for all existing posts with no Schema selected.</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-12 gap-8 py-6 px-6 border-b border-gray-100">
                  ...
                  <div className="col-span-8">
                    <label className="relative inline-block w-[42px] h-[22px] align-middle select-none transition duration-200 ease-in cursor-pointer mb-2">
                        <input type="checkbox" checked={settings.seo_attachment_autodetect_video === 'true'} onChange={() => toggleBoolean('seo_attachment_autodetect_video')} className="sr-only peer" />
                        <div className="w-full h-full bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-[18px] after:w-[18px] after:transition-all peer-checked:bg-[#0085ba]"></div>
                    </label>
                    <p className="text-[13px] text-gray-500">Populate automatic Video Schema by auto-detecting any video in the content.</p>
                  </div>
                ...
                <div className="grid grid-cols-12 gap-8 py-6 px-6 border-b border-gray-100">
                  <div className="col-span-4">
                    <label className="text-[14px] font-bold text-gray-700">Autogenerate Image</label>
                  </div>
                  <div className="col-span-8">
                    <label className={`relative inline-block w-[42px] h-[22px] align-middle select-none transition duration-200 ease-in mb-2 ${settings.seo_attachment_autodetect_video === 'true' ? 'cursor-pointer' : 'cursor-not-allowed opacity-50'}`}>
                        <input type="checkbox" disabled={settings.seo_attachment_autodetect_video !== 'true'} checked={settings.seo_attachment_autogen_image === 'true'} onChange={() => toggleBoolean('seo_attachment_autogen_image')} className="sr-only peer" />
                        <div className="w-full h-full bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-[18px] after:w-[18px] after:transition-all peer-checked:bg-[#0085ba]"></div>
                    </label>
                    <p className="text-[13px] text-gray-500">Auto-generate image for the auto detected videos.</p>
                  </div>
                </div>

                <div className="grid grid-cols-12 gap-8 py-6 px-6 border-b border-gray-100">
                  <div className="col-span-4">
                    <label className="text-[14px] font-bold text-gray-700">Media Robots Meta</label>
                  </div>
                  <div className="col-span-8">
                    <label className="relative inline-block w-[42px] h-[22px] align-middle select-none transition duration-200 ease-in cursor-pointer mb-2">
                        <input type="checkbox" checked={settings.seo_attachment_robots !== 'default'} onChange={() => handleChange('seo_attachment_robots', settings.seo_attachment_robots === 'default' ? 'Index' : 'default')} className="sr-only peer" />
                        <div className="w-full h-full bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-[18px] after:w-[18px] after:transition-all peer-checked:bg-[#0085ba]"></div>
                    </label>
                    <p className="text-[13px] text-gray-500 mb-4">Select custom robots meta, such as <code className="bg-gray-100 px-1 py-0.5 rounded">noindex</code>, <code className="bg-gray-100 px-1 py-0.5 rounded">nofollow</code>, etc. for single Media pages. Otherwise the default meta will be used, as set in the Global Meta tab.</p>
                    
                    {settings.seo_attachment_robots !== 'default' && (
                      <div className="grid grid-cols-2 gap-4">
                        {['Index', 'No Index', 'No Follow', 'No Archive', 'No Image Index', 'No Snippet'].map(robot => {
                          const currentRobots = settings.seo_attachment_robots ? settings.seo_attachment_robots.split(',') : [];
                          return (
                            <label key={robot} className="flex items-center gap-2">
                              <input 
                                type="checkbox" 
                                ...
                                onChange={(e) => {
                                  ...
                                  newRobots = Array.from(new Set(newRobots));
                                  handleChange('seo_attachment_robots', newRobots.join(','));
                                }}
                                className="w-4 h-4 text-[#0085ba] rounded border-gray-300 focus:ring-[#0085ba]" 
                              />
                              <span className="text-[13px] text-gray-700 flex items-center gap-1">{robot} <span className="inline-flex items-center justify-center w-3 h-3 bg-gray-200 text-gray-500 rounded-full text-[9px] font-bold font-serif italic">i</span></span>
                    ...
                    <p className="text-[12px] text-gray-500 mt-3">Custom values for robots meta tag on Media.</p>
                  </div>
                </div>

                <div className="grid grid-cols-12 gap-8 py-6 px-6 border-b border-gray-100">
                  <div className="col-span-4">
                    <label className="text-[14px] font-bold text-gray-700">Media Advanced Robots Meta</label>
                  </div>
                  <div className="col-span-8">
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                ...
                <div className="grid grid-cols-12 gap-8 py-6 px-6 border-b border-gray-100 last:border-0">
                  <div className="col-span-4">
                    <label className="text-[14px] font-bold text-gray-700">Default Thumbnail Watermark</label>
                  </div>
                  <div className="col-span-8">
                    <div className="flex border border-gray-300 rounded w-max overflow-hidden mb-2">
                      {['Off', 'Play icon', 'GIF icon'].map(opt => {
                        const isActive = (settings.seo_attachment_default_watermark || 'Off') === opt;
                        return (
                          <button
                            key={opt}
                            onClick={() => handleChange('seo_attachment_default_watermark', opt)}
                            className={`px-4 py-1.5 text-[13px] font-medium transition-colors border-r border-gray-300 last:border-0 ${isActive ? 'bg-[#0085ba] text-white' : 'bg-white text-gray-700 hover:bg-gray-50'}`}
                          >
                            {opt}
                          </button>
                    ...
                    <p className="text-[13px] text-gray-500">Select the default watermark that will be applied if no specific watermark is selected.</p>
                  </div>
                </div>
