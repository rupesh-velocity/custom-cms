  ...
  return (
    <div className="font-sans text-[13px] text-[#3c434a]">
      ...
      <div className="flex text-[13px] mb-2 text-[#50575e]">
        <Link href="/admin/pages" className={statusFilter === 'All' ? 'font-semibold text-black' : 'text-[#5e3fde] hover:underline'}>All <span className="text-gray-500 font-normal">({allCount})</span></Link>
        <span className="mx-1 text-gray-300">|</span>
        <Link href="/admin/pages?status=Published" className={statusFilter === 'Published' ? 'font-semibold text-black' : 'text-[#5e3fde] hover:underline'}>Published <span className="text-gray-500 font-normal">({publishedCount})</span></Link>
        <span className="mx-1 text-gray-300">|</span>
        <Link href="/admin/pages?status=Draft" className={statusFilter === 'Draft' ? 'font-semibold text-black' : 'text-[#5e3fde] hover:underline'}>Draft <span className="text-gray-500 font-normal">({draftCount})</span></Link>
        <span className="mx-1 text-gray-300">|</span>
        <Link href="/admin/pages?status=Trash" className={statusFilter === 'Trash' ? 'font-semibold text-black' : 'text-[#5e3fde] hover:underline'}>Trash <span className="text-gray-500 font-normal">({trashCount})</span></Link>
      </div>
